...
if (strlen($_SESSION['login']) == 0) {
    ...
    <html lang="en">
    <head>
        <title>RollNRent - My Booking</title>
        <!--Bootstrap -->
            ...
            <div class="container">
                <div class="user_profile_info gray-bg padding_4x4_40">
                    <div class="upload_user_logo">
                        <img src="assets/images/RNR.png" alt="image">
                    </div>
                                ...
                                <ul class="vehicle_listing">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        ...
                                        foreach ($results as $result) {
                                            // Calculate the total for each booking
                                            $totalForBooking = $result->totaldays * $result->PricePerDay;
                                            // Add the total for this booking to the grand total
                                            $grandTotal += $totalForBooking;
                                            ?>
                                            <li>
                                                <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber); ?></h4>
                                                <div class="vehicle_img">
                                                    <a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid); ?>"><img
                                                                src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>"
                                                                alt="image"></a></div>
                                                <div class="vehicle_title">

                                                    <h6><a
                                                                href="vehical-details.php?vhid=<?php echo htmlentities($result->vid); ?>"><?php echo htmlentities($result->VehiclesTitle); ?></a>
                                                    </h6>
                                                    <p><b>From </b> <?php echo htmlentities($result->FromDate); ?>
                                                        <b>To </b> <?php echo htmlentities($result->ToDate); ?></p>
                                                ...
                                                <?php } else if ($result->Status == 2) { ?>
                                                    ...
                                                    <?php } else { ?>
    <div class="vehicle_status">
        <a href="payment/razorpay_payment.php?amount=<?php echo $grandTotal; ?>" class="btn outline btn-xs">Pay Now</a>
        <div class="clearfix"></div>
    </div>
<?php } ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlentities($totalForBooking); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <p>Nb: If You Paid The Pay now Button Will Change Shortly We Are Reviewing It From Our End</p>
                                        <hr />
                                    <?php }}  else { ?>
